...
def test_validator():
    ...
    """
    v = validator.SchemaValidator("./tests/files/validator_constraints.ttl", "./tests/files/test_report.html")
    ...
    assert(len(v.reports["Movie"]) == len(expected)), "Expected report count not equal."
