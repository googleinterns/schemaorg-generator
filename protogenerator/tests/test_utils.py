...
def test_to_snake_case():
    ...
    Verification:
        - Check if all the outputs generated by the function is equal to corresponding expected output. 
...
def test_topological_sort():
    ...
    Procedure:
        - Create a dict.
        - Populate the dict like with adjacency list representation of every node.
        - Create an expected output of topological ordering.
        - Call utils.toplogical_sort for the graph.
    
    Verification:
        - Check if all the output generated by the function is the same order are expected output. 
    """
...
def test_get_children():
    ...
    Procedure:
        - Create a graph dict.
        - Populate the graph dict like with adjacency list representation of every node.
        - The final graph shud be of tree structure and must be multiple levels deep.
        - Create another answer dict.
        - Populate answer dict with all the children of every node.
        - Call utils.toplogical_sort for the graph.
    
    Verification:
        - Check if all the output dict generated by the function is similar to the answer dict. 
    """
